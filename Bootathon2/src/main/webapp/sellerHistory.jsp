...
<head>
    ...
    <style><%@include file="/WEB-INF/style/sellerHistory.css"%></style>
...
<body>
	...
	<%
		...
		try{
			array=new SqlDao().get_user_Sold_Products(seller.getEmail());
		}
		catch(Exception e){
                ...
                <div class="table-responsive ">
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                <th class="sp" scope="col">S.NO	</th>
                                <th class="sp" scope="col">Name</th>
                                <th class="sp" scope="col">Bider's Email</th>
                                <th class="sp" scope="col">Bid Price</th>
                              </tr>
                        </thead>
                        <tbody>
                            ...
                            <%
                        		...
                        		if(pro.getUser_Email()==null){
                        			pro.setUser_Email("No Bidders Available");
                        			pro.setBid_price("-");
                        		}
                        	%>
                                ...
                                <td class="sa"><%=pro.getUser_Email() %></td>
