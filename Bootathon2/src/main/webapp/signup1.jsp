    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="ch1 card">
                    <div class="card-body">
                        <img class="img-fluid my-2" id="photo"src="images/shop1.png">
            ...
            <div class="col-md-5">
                <div class="form-inline">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" class="i11 form-control" id="pp3" name="district"  placeholder="District">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="i11 form-control" id="pp4" name="state" placeholder="State">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 my-3">
                            <input type="text" class="i11 form-control" id="pp5" name="country"  placeholder="Country">
                        </div>
                        <div class="col-md-4 my-3">
                            <input type="text" class="i11 form-control" id="pp6" name="pin"  placeholder="Pin">
                        </div>
                    </div>
                    ...
                    <button class="dark btn btn-dark" id="call">SignUp</button>
                </div>
            </div>
        </div>
    </div>
  ...
  $(document).ready(function() {
	  $('#call').on('click',function(){
          ...
          if(pass!==rpass){
	          ...
	          $.ajax({
	              type: "post",
	              url: "Buyer_signup", //this is my servlet
