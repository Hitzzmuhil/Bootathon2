...
<head>
   ...
   <style><%@include file="/WEB-INF/style/signup1.css"%></style>
    <style><%@include file="/WEB-INF/style/signup2.css"%></style>
...
<body>
    ...
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg navbar-light bg-light" id="sn8">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                <a class="nav-link" href="seller_login.jsp">Log In</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="ch1 card">
                    <div class="card-body">
                        <img class="img-fluid my-2" id="photo"src="images/shop2.png">
            ...
            <div class="col-md-5">
                <div class="form-inline">
                    <h2  class="tt1">SignUp (Bussiness)</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <input class="i11 form-control" id="pp" type="text" name="first" placeholder="FirstName">
                        </div>
                        <div class="col-md-4">
                            <input class="i11 form-control" id="pp1" type="text" name="last" placeholder="LastName">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10">
                            <input type="email" class="i11 form-control my-3" id="pp2" name="email" placeholder="Email">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" class="i11 form-control" name="district" id="pp3" placeholder="District">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="i11 form-control" name="state" id="pp4" placeholder="State">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 my-3">
                            <input type="text" class="i11 form-control" name="country" id="pp5" placeholder="Country">
                        </div>
                        <div class="col-md-4 my-3">
                            <input type="text" class="i11 form-control" name="pin" id="pp6" placeholder="Pin">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <select class="form-select i11" name="phcode" aria-label="Default select example">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="i11 form-control" name="no" id="pp7" placeholder="Phone Number">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-5 my-3">
                            <input type="password" class="i11 form-control" name="pass" id="pp8" placeholder="Password">
                        </div>
                        <div class="col-md-5 my-3">
                            <input type="password" class="i11 form-control" name="rpass" id="pp9" placeholder="Re-EnterPassword">
                        </div>
                    </div>
                    <button type="submit" id="call" class="dark btn btn-dark">SignUp</button>
                </div>
            </div>
        </div>
    </div>
  ...
  $(document).ready(function() {
	  ...
	  $('#call').on('click',function(){
          ...
          if(pass!==rpass){
	          ...
	          $.ajax({
	              type: "post",
	              url: "Seller_signup", //this is my servlet
	              data:{first:first,last:last,country:country,district:district,state:state,email:email,no:no,pin:pin,pass:pass},
	              success: function(msg){      
	            	  msg=msg.trim();
	                    if(msg==="true"){
	                    	window.location.href="seller_login.jsp";
	                    }
	                    else{
