            ...
            <div class="row">
                <div class="col-md-5"> 
                    <div class="card my-4 cr ">
                        <h2 class="xs mm">Product details</h2>
                        <h3 class="xp my-4 mx-4 " id="xe"><%=product.getProduct_name().toUpperCase() %></h3>
                        
                        <p class="xp1 mx-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%="		"+product.getProduct_description() %>
                           </p>
                        <span class="tp mx-4"><small class="xp">Bid Ends By: </small><b class="mx-2"><%=product.getEnd_date()%></b> </span>
                        <span class="my-3 mx-4"><small class="xp">Base Price </small><b class="mx-2" id="base" ><%=product.getBase_price()%></b><span>$</span> </span>
                        <label></label>
                        <%
                        	int highest_price=0;
                        try{
                ...
                <div class="col-md-7">
                    ...
                    <button class="btn btn-dark my-2"data-bs-toggle="modal" data-bs-target="#exampleModal" id="llp" type="submit">Place Bid</button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Auction House</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                            <form>
                                <input  class="form-control my-2 dis" id="curr" placeholder="100$">
                            </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-dark my-2" id="llp1">Bid</button>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      $('#llp1').click(function(){
            ...
            var curr = document.getElementById("curr").value;
              ...
              $.ajax({
	              type:"post",
	              url: "PlaceBid",
	              data:{base:base,high:high,curr:curr},
